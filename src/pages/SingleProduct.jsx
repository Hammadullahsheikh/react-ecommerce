    ...
    <>
      {
        data ? (
          <div className="card lg:w-2/3 mx-auto bg-base-100 shadow-2xl p-6 rounded-lg md:my-16">
            <figure className="w-full h-72 mt-5">
              <img
            ...
            <div className="card-body">
              ...
              <h3 className="text-xl font-semibold text-orange-700 mb-6">${data.price}</h3>
              <div className="card-actions justify-end">
                <button className="btn  bg-[#EF0808] btn-lg text-white">Buy Now</button>
              </div>
            </div>
          </div>
        ) : (
